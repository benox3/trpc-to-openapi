...
const errors_1 = require("../adapters/node-http/errors");
...
const hasInputs = (schema) => (0, zod_2.instanceofZodType)(schema) && !(0, zod_2.instanceofZodTypeLikeVoid)((0, zod_2.unwrapZodType)(schema, true));
...
const errorResponseFromStatusCode = (status) => {
    const code = errors_1.HTTP_STATUS_TRPC_ERROR_CODE[status];
...
const getResponsesObject = (schema, httpMethod, headers, isProtected, hasInputs, successDescription, errorResponses) => (Object.assign({ 200: {
        ...
        content: {
            'application/json': {
                schema: (0, zod_2.instanceofZodTypeKind)(schema, zod_1.z.ZodFirstPartyTypeKind.ZodVoid)
                    ? {}
                    : (0, zod_2.instanceofZodTypeKind)(schema, zod_1.z.ZodFirstPartyTypeKind.ZodNever) ||
                        (0, zod_2.instanceofZodTypeKind)(schema, zod_1.z.ZodFirstPartyTypeKind.ZodUndefined)
                        ? { not: {} }
                        : schema,
            },
        },
