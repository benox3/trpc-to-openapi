...
const getOpenApiPathsObject = (appRouter, securitySchemeNames) => {
    const pathsObject = {};
    const procedures = (0, lodash_clonedeep_1.default)(appRouter._def.procedures);
    (0, procedure_1.forEachOpenApiProcedure)(procedures, ({ path: procedurePath, type, procedure, openapi }) => {
        ...
        try {
            ...
            if (!(0, zod_2.instanceofZodType)(inputParser)) {
                throw new server_1.TRPCError({
                    message: 'Input parser expects a Zod validator',
                    code: 'INTERNAL_SERVER_ERROR',
                });
            }
            if (!(0, zod_2.instanceofZodType)(outputParser)) {
                throw new server_1.TRPCError({
            ...
            const requestData = {};
            if (!(pathParameters.length === 0 && (0, zod_2.instanceofZodTypeLikeVoid)(inputSchema))) {
                if (!(0, zod_2.instanceofZodTypeObject)(inputSchema)) {
                    throw new server_1.TRPCError({
                        message: 'Input parser must be a ZodObject',
                        code: 'INTERNAL_SERVER_ERROR',
                    });
                }
                if ((0, method_1.acceptsRequestBody)(method)) {
